#ifndef RGI_COMMON_URP_TRANSLATORS
#define RGI_COMMON_URP_TRANSLATORS

	// Copyright 2022 Kronnect - All Rights Reserved.
	
    // URP to built-in translators
    #define TEXTURE2D_X(tex) UNITY_DECLARE_TEX2D_NOSAMPLER(tex)
    ...
    #define SAMPLE_TEXTURE2D_X(tex, sampler, uv) tex.Sample(sampler, uv)
...
#endif // RGI_COMMON_URP_TRANSLATORS