Shader "Hidden/Kronnect/RadiantGI" {
Properties {
    _MainTex("", any) = "" {}
    _Color("", Color) = (1,1,1)
...
//    #pragma enable_d3d11_debug_symbols
  ...
  Pass { // 1
      ...
      #pragma multi_compile_local _ _FORWARD _FORWARD_AUTONORMALS
  ...
  Pass { // 8
      ...
      #pragma multi_compile_local _ _FORWARD _FORWARD_AUTONORMALS
      #pragma multi_compile_local _ _FORWARD_AND_DEFERRED
  ...
  Pass { // 20
      Name "Copy Multi-taps"
      HLSLPROGRAM
      #pragma vertex VertRGI
      #pragma fragment FragCopyMultiTaps
      #include "RadiantGI_Blends.hlsl"
      ENDHLSL
  }
}
